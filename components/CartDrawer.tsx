                  ...
                  <div>
                    <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col items-end group">
                             <span className="text-sm font-light text-[#2C2A26] block group-hover:hidden">KSh {item.price.toLocaleString()}</span>
                             <span className="text-sm font-light text-[#2C2A26] hidden group-hover:block">${Math.round(item.price / 130)}</span>
                        </div>
                    </div>
        ...
        <div className="p-6 border-t border-[#D6D1C7] bg-[#EBE7DE]/30">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-right group">
                 <span className="text-xl font-serif text-[#2C2A26] block group-hover:hidden">KSh {total.toLocaleString()}</span>
                 <span className="text-xl font-serif text-[#2C2A26] hidden group-hover:block">${Math.round(total / 130)}</span>
            </div>
          </div>

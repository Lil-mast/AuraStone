    ...
    <div className="group flex flex-col gap-6 cursor-pointer" onClick={() => onClick(product)}>
      ...
      <div className="text-center">
        ...
        <div className="relative inline-block h-6 overflow-hidden">
             <span className="text-sm font-medium text-[#2C2A26] block transition-transform duration-300 transform group-hover:-translate-y-full">
                KSh {product.price.toLocaleString()}
             </span>
             <span className="text-sm font-medium text-[#2C2A26] block transition-transform duration-300 transform translate-y-full group-hover:-translate-y-full absolute top-0 left-0 right-0">
                ${usdPrice}
             </span>
        </div>
      </div>
